...
#import "LUSafeMutableArray.h"

@implementation LUSafeMutableArray{
    CFMutableArrayRef _array;
}

- (id)init {
    return [self initWithCapacitys:0];
}

- (id)initWithCapacitys:(NSUInteger)numItems {
    self = [super init];
    if (self) {
